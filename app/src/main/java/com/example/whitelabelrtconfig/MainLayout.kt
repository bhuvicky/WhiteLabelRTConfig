...
fun ImageTextSlider() {
    val pair = listOf(
        Pair(R.drawable.image2, "Smoth onboarding to charge yourself")
    )
    ...
    Column(
        ...
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .background(uiState.bgColor.parseColor()),
        ...
        Column(
            ...
            CustomButton(
                ...
                backgroundColor = uiState.b1Color.parseColor(),  // Change Background Color
            ...
            CustomButton(
                ...
                onClick = { /* Handle Click */ },
                backgroundColor = uiState.b1Color.parseColor(),  // Change Background Color
                textColor = uiState.b2Color.parseColor(),     // Change Text Color
                cornerRadius = 25,            // Change Corner Radius
                fontSize = 20,                // Change Font Size
                fontWeight = FontWeight.Medium, // Change Font Weight
            ...
            if (uiState.shouldShowUi) {
                CustomButton(
                    ...
                    onClick = { /* Handle Click */ },
                    backgroundColor = uiState.b1Color.parseColor(),  // Change Background Color
                    textColor = uiState.textColor.parseColor(),     // Change Text Color
            ...
            Row(
                ...
                Button (
                    ...
                    onClick = { viewModel.clientAButtonClick() }
                ) {
                    Text(text = "Client A")
                }
                ...
                Button (
                    modifier = Modifier.padding(start = 16.dp),
                    onClick = { viewModel.clientBButtonClick() }
                ) {
                    Text(text = "Client B")
                }
            }
